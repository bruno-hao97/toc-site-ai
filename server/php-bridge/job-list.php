...
foreach ($rows as $row) {
    ...
    $items[] = [
        ...
        'mode' => $meta['mode'] ?? null,
        'coverUrl' => $meta['coverUrl'] ?? ($meta['cover_url'] ?? null),
        'voiceId' => $meta['voice_id'] ?? ($meta['voiceId'] ?? null),
        'server' => $meta['server'] ?? ($meta['provider'] ?? null),
        'duration' => $meta['duration'] ?? null,
        'fileSize' => isset($meta['file_size']) ? (int) $meta['file_size'] : (isset($meta['fileSize']) ? (int) $meta['fileSize'] : null),
